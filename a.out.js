...
// Begin JS library code
  ...
  /** @type {function(...*):?} */
  function __emscripten_stack_restore(
  ) {
  abort('missing function: _emscripten_stack_restore');
  }
  __emscripten_stack_restore.stub = true;
  var stackRestore = (val) => __emscripten_stack_restore(val);

  /** @type {function(...*):?} */
  function _emscripten_stack_get_current(
  ) {
  abort('missing function: emscripten_stack_get_current');
  }
  _emscripten_stack_get_current.stub = true;
